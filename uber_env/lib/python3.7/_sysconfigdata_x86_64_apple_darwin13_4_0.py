...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BLDSHARED': 'x86_64-apple-darwin13.4.0-clang -bundle -undefined '
              ...
              '-Wl,-rpath,/media/dhruv/Local Disk/Taxi_Fare_Model/uber_env/lib '
 ...
 'CFLAGS': '-fno-strict-aliasing -Wsign-compare -Wunreachable-code -DNDEBUG '
           ...
           '-fdebug-prefix-map=/media/dhruv/Local Disk/Taxi_Fare_Model/uber_env=/usr/local/src/conda-prefix '
 ...
 'CONFIGURE_LDFLAGS': '-Wl,-pie -Wl,-headerpad_max_install_names '
                      ...
                      '-L/media/dhruv/Local Disk/Taxi_Fare_Model/uber_env/lib '
                      '-flto -Wl,-export_dynamic',
 'CONFIG_ARGS': "'--prefix=/media/dhruv/Local Disk/Taxi_Fare_Model/uber_env' "
 ...
 'LIBFFI_INCLUDEDIR': '/media/dhruv/Local Disk/Taxi_Fare_Model/uber_env/include',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/media/dhruv/Local Disk/Taxi_Fare_Model/uber_env/lib/pkgconfig',
 'LIBPL': '/media/dhruv/Local Disk/Taxi_Fare_Model/uber_env/lib/python3.7/config-3.7m-darwin',
 ...
 'NO_AS_NEEDED': '',
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/media/dhruv/Local Disk/Taxi_Fare_Model/uber_env/include',
 'OPENSSL_LDFLAGS': '-L/media/dhruv/Local Disk/Taxi_Fare_Model/uber_env/lib',
